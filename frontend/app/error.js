...
export default function ErrorPage({ error, reset }) {
    ...
    return (
        <div className="flex items-center  bg-gradient-to-r from-purple-500 justify-center min-h-screen via-pink-500 to-red-500">
            <motion.div
            ...
            >
                ...
                <p className="mt-4 text-gray-500 text-sm">
                    ...
                    Wait, redirecting automatically in 5 seconds...
                </p>
            </motion.div>
        </div>
    );
